...
INSERT INTO `factura_producto` VALUES (13,2,1,0.00),(13,3,1,10.00);
...
INSERT INTO `facturas` VALUES (13,'12345678910','2024-07-31 06:25:03',50.00,2);
...
INSERT INTO `productos` VALUES (2,'prueba','prueba de post',0.00,0,'2024-07-18 16:22:02','string'),(3,'creatina','creatina de greg doucette',10.00,5,'2024-07-31 06:03:28','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgwQWqjRtAMTivXU3yJE3ZF_tGjzSA2uBlLg&s');
...
INSERT INTO `usuarios` VALUES (2,'fmn','fran1412','Francisco Madera Natera','franciscomaderanatera@gmail.com',1,'2024-07-23 05:17:01','2024-07-23 05:17:01');
...
BEGIN
	IF pp_product_id IS NULL AND pp_name IS NULL AND pp_carrito_id IS NULL THEN
		SELECT * FROM productos;
	ELSE
		IF pp_name IS NULL AND pp_carrito_id IS NULL THEN
...
-- Dump completed on 2024-09-12 15:34:19
